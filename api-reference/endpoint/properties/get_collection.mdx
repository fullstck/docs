...
<ParamField query="includedDepartments" type="array" >
  Located in given departments. Example: `includedDepartments[]=/departments/77`. Use [locations](/api-reference/endpoint/indicators/locations) to get the desired ids.
</ParamField>
