...
description: "This endpoint returns the points of interests matching the given criteria."
---

### Query parameters

<ParamField query="facilities[]" type="array" placeholder="school, kindergarten, restaurant...">
