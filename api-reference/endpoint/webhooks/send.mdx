...
<Tip>
In order to use webhooks in production, you need to provide an `endpointRecipient` or/and an `eventEndpoint` on the [POST /searches](http://docs.melo.io/api-reference/endpoint/searches/create) endpoint and choose the events you want to subscribe to using the `subscribedEvents` parameter.
</Tip>
