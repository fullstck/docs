...
<Tip>
In order to use webhooks in production, you need to provide an `endpointRecipient` or/and an `eventEndpoint` on [POST /searches](http://docs.melo.io/api-reference/endpoint/searches/create).

You can choose the events you want to subscribe to using the `subscribedEvents` parameter. All events are listed below this section.
