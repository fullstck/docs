...
If you want to get an access and try out the API, please [sign up](https://www.melo.io) and create an API key in your settings. It is important to keep your API Key private and secure.
...
curl --location -g --request GET 'https://api.notif.immo/documents/properties/{id}' \
